...
class DelayRelayNode(Node):
    def __init__(self):
        ...
        self.pub_ficforce = self.create_publisher(Float64,
                                              ...
                                              10)
        # ===== Publishers for delay values =====
        self.pub_h1 = self.create_publisher(Float64, '/delay/h1', 10)
        self.pub_h2 = self.create_publisher(Float64, '/delay/h2', 10)
    ...
    def timer_callback(self):
        ...
        msg_h1 = Float64()
        msg_h1.data = self.h1
        self.pub_h1.publish(msg_h1)

        msg_h2 = Float64()
        msg_h2.data = self.h2
        self.pub_h2.publish(msg_h2)
        now = self.get_clock().now()
